...
import com.example.bookshop.databinding.FragmentPlanBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding){
            ...
            viewModel.data.observe(viewLifecycleOwner){ dataClasses ->
                adapter.submitList(dataClasses.listBook.filter { it.usersWont.contains(FirebaseAuth.getInstance().currentUser!!.uid) })
            }
